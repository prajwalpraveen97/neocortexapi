...
namespace NeoCortexApi.Utility
{
    ...
    public static class ArrayUtils
    {
        ...
        /// <returns></returns>
        public static List<String[]> ReadCsvFileText(String path,Boolean skipHeaderRow, int featureNumber, char delimiter )
        {
            ...
            int n = 0;
            if (skipHeaderRow) { n = 1; }
            for (; n < integerStrings.Length; n++)
            {
                String s = integerStrings[n];

                String[] sub_data = s.Split(delimiter);
               textList.Add(sub_data);
